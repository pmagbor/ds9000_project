...
## Dataset:
This MOTUM dataset (Multi-origin brain tumor MRI) contains MRI images from 67 patients diagnosed with aggressive malignant brain tumours. These tumours are categorized into two types: high grade gliomas (HGG) and brain metastases (BM). 
...
[MOTUM Repository (G-Node)](https://gin.g-node.org/hongweilibran/motum)

[MOTUM Dataset (Harvard Dataverse)](https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/KUUEWC)
