...
*train_3dmultimodal_train_val_test.py*: cript used to train 3D ResNet-18 on the T1, T2 and FLAIR form all patients included in the analysis. Training data was split into train, val, and test. Evaluation of the model was also performed on in the script and performance metrices where computed. 

*metrics*: Used to compute the evaluation metrices 
